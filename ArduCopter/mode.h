...
public:
    ...
    enum class Number : uint8_t {
        ...
        PROTECTED =    29,  // Flip over after crash
...
class ModeProtected : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::PROTECTED; }
...
protected:
    ...
    const char *name4() const override { return "PROTEC"; }
